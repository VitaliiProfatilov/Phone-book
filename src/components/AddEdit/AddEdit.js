    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.content}>
                <h2>
                    {window.location.href === 'http://localhost:3000/Add' ? 'Register new contact' : 'Edit contact'}
                </h2>
                ...
                <Link to={go() && '/' } >
                    <button onClick={() => {window.location.href === 'http://localhost:3000/Add' ? go() && contactsData 
                        ({
                            name: name,
                            lastName: lastName,
                            address: address,
